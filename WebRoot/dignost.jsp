...
<table width="668" border="1">
  <tbody>
    ...
    <tr>
      <td >既往史：</td>
      <td><textarea name="textarea" id="pathHistory"></textarea></td>
    </tr>
    <tr>
      <td>过敏史：</td>
      <td><textarea name="textarea2" id="pathAllergy"></textarea></td>
    </tr>
    <tr>
      <td>病情症状：</td>
      <td><textarea name="textarea3" id="pathSymptom"></textarea></td>
    </tr>
    <tr>
      <td>病情分析：</td>
      <td><textarea name="textarea4" id="pathAnalyse"></textarea></td>
    </tr>
    <tr>
