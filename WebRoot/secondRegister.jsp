...
function submitFormData(){
	...
	xmlHttp.open("POST","register_operateSecondRegister.do",true);
  ...
  <tbody>
    <tr>
      <td colspan="2" align="center"><blockquote>
        <p>复诊挂号单</p>
        <p>病历号：<label id="dignostId">${sessionScope.existPatient.pathId}</label></p>
      </blockquote></td>
    </tr>
    <tr>
      <td width="127">病人姓名：</td>
      <td width="312"><input type="text" name="patientName" id="patientName" value="${sessionScope.existPatient.patientName}"></td>
    </tr>
    <tr>
      <td>性别：</td>
      <td><p>
...
<label>
  <input type="radio" name="RadioGroup1" value="女" id="RadioGroup1_1">
    ...
    <tr>
      <td>年龄：</td>
      <td><input type="text" name="patientAge" id="patientAge" value="${sessionScope.existPatient.patientAge}"></input> 
        岁 </td>
    </tr>
    <tr>
      <td>住宅地址：</td>
      <td><input type="text" name="patientAddress" id="patientAddress" value="${sessionScope.existPatient.patientAddress}"></td>
    </tr>
    <tr>
      <td colspan="2"><label for="select">挂号科室:</label>
        <select name="depts" id="depts">
        <s:iterator value="#session.depts" var="d">
